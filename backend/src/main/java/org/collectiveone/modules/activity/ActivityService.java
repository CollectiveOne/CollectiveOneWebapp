...
public class ActivityService {
	...
	@Transactional
	public void messagePosted(Message message, AppUser triggerUser, MessageThreadContextType contextType, UUID elementId, List<AppUser> uuidsOfMentions) {
		...
		activity.getMentions().addAll(uuidsOfMentions);
