...
UPDATE token_holders SET tokens = ((SELECT tokens FROM token_holders WHERE holder_id = 'ac101306-5d7e-1082-815d-80b6ed2c00e6') + (SELECT value FROM member_transfers WHERE id = 'ac11c8da-60b9-1c85-8160-bc0a1dd20000')) WHERE holder_id = 'ac101306-5d7e-1082-815d-80b6ed2c00e6';
UPDATE token_holders SET tokens = ((SELECT tokens FROM token_holders WHERE holder_id = 'ac1153fa-6031-1f63-8160-35c6a8b50086') + (SELECT value FROM member_transfers WHERE id = 'ac11c8da-60b9-1c85-8160-bc0a1f0d0003')) WHERE holder_id = 'ac1153fa-6031-1f63-8160-35c6a8b50086';
UPDATE token_holders SET tokens = ((SELECT tokens FROM token_holders WHERE holder_id = 'ac119fe2-5da2-1e75-815d-a71185260000') + (SELECT value FROM member_transfers WHERE id = 'ac11c8da-60b9-1c85-8160-bc0a1f4a0004')) WHERE holder_id = 'ac119fe2-5da2-1e75-815d-a71185260000';
UPDATE token_holders SET tokens = ((SELECT tokens FROM token_holders WHERE holder_id = 'ac12d946-5d60-1f44-815d-60bfa34c0000') + (SELECT value FROM member_transfers WHERE id = 'ac11c8da-60b9-1c85-8160-bc0a1f840005')) WHERE holder_id = 'ac12d946-5d60-1f44-815d-60bfa34c0000';
UPDATE token_holders SET tokens = ((SELECT tokens FROM token_holders WHERE holder_id = 'ac12fa3a-5d73-191b-815d-74e4b8200000') + (SELECT value FROM member_transfers WHERE id = 'ac11c8da-60b9-1c85-8160-bc0a1fd70006')) WHERE holder_id = 'ac12fa3a-5d73-191b-815d-74e4b8200000';
